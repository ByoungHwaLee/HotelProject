...
<form:form commandName="sel" action="selInfo.ad" method="post">
...
<a href="<%=request.getContextPath() %>/selList.ad">목록으로</a>
<a href="<%=request.getContextPath() %>/selDelete.ad?num=${seller.num }">이 판매자 삭제하기</a>
