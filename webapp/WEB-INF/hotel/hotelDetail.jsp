...
<script>
	$(function() {
			var scroll=0;
			var scroll_flag="${scroll}";
			if(scroll_flag==true){
				var offset=$(".register-wrap").offset();
...
<div class="total-container">
	...
	<div class="left-bar">  
		...
		<div class="leftSearch-wrap" >
			<form action="Search.ho" method="get" class="leftsearch-form">
				<h4>검색</h4>
				<div class="searchinput">
					<p><span class="searchinputSpan">여행지 이름:</span>
					<input class="inputbox" type="text" name="area" placeholder="지역을 입력하세요"
						value="${param.area }">
					</p>
					<div class="searcharea-p scheduler">
						<p><span class="searchinputSpan">체크인 날짜:</span>
						<input class="inputbox"  name="checkin" type="text" id="datepicker" placeholder="체크인" value="${param.checkin }" autocomplete="off"></p>
						
						<p><span class="searchinputSpan">체크아웃 날짜:</span>
						<input class="inputbox"  name="checkout" type="text" id="datepicker2" placeholder="체크아웃" value="${param.checkout }" autocomplete="off"></p>
					</div>  
					...
					<div class="personbox">
						<div class="perbox-box">
							<div>
									...
									<select class="adultselect" name="adult">
							...
							<div>
									...
									<select class="crselect" name="child">
									...
									<select class="crselect" name="room">
		...
		<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=ee8a8a2bbdb6126a316912323f82203d&libraries=services	"></script>
		<script>
			...
			<div class="modal-content">
				...
				<form name="reviewForm" id="reviewForm">
					<p class="searcharea-p scheduler">
						...
						<input class="inputbox"  name="checkin" type="text" id="datepicker3" placeholder="체크인" value="${param.checkin }" autocomplete="off">
						<br>
							<span class="searchinputSpan">체크아웃 날짜:</span>
							<input class="inputbox"  name="checkout" type="text" id="datepicker4" placeholder="체크아웃" value="${param.checkout }" autocomplete="off">
					</p>
					...
					<div class="perbox-box">
							...
							<div>
									...
									<option class="mchild" value="0" <c:if test="${param.child == 0 }">selected</c:if>>아동 없음</option>
									<c:forEach begin="1" end="20" var="p">
										
										<option class="mchild" value="${p }" <c:if test="${param.child == p }">selected</c:if>>아동: ${p }명</option>
