...
<div>
	...
	<div class="left-bar">
		...
		<div class="leftSearch-wrap">
			<form action="Search.ho" method="post" class="leftsearch-form">
				...
				<div class="searchinput">
					...
					<input class="inputbox" type="text" name="area" placeholder="지역을 입력하세요" value="${param.area }">
					<br>
					<p class="searcharea-p scheduler">
						<span class="searchinputSpan">체크인 날짜:</span>
						<input class="inputbox"  name="checkin" type="text" id="datepicker" placeholder="체크인" value="${param.checkin }"><br><br>
		...
		<!-- 지도를 담을영역 --> 
		<div id="map" style="width:100%;height:300px; border-radius:5px; padding:10; border:1px; margin:auto; margin-bottom:3px;">
