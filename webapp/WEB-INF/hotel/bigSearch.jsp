						...
						<div class="perbox-box">
							<div>
									...
									<c:forEach begin="1" end="20" var="p">
										...
										<option class="adult" value="${p }" <c:if test="${search.adult eq p }">selected</c:if>>성인: ${p }명</option>
					...
					<tr class="tablerow" >
						...
						<tr>
							<td class="hanmeFirst"><span class="htypesearch">${hotel.h_type }</span>
								<a class="hnamesearch" href="hotelDetail.ho?h_num=${hotel.h_num }&area=${search.area}&checkin=${search.checkin}&checkout=${search.checkout}&adult=${search.adult}&child=${search.child}&room=${search.room}">
														<b>${hotel.h_name }</b>
